...
import image360 from "../../public/360.jpg";
    ...
    <main className={`flex w-full h-full min-h-screen p-4 bg-base-white`}>
      ...
      >
        <div className="flex flex-col pt-4 px-4 justify-center items-center">
          ...
          <span className="text-xl text-base-white font-bold mb-6 twe">
          ...
          <span className="text-base-white text-center font-semibold">
            ...
            aplicativo. Em seguida, será possível rotacionar a imagem para obter
            uma visão em 360 graus da Sala Brasil no Museu Ibiporã!
          </span>
